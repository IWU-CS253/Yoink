# Yoink
A project to build an app where students can share their leftover supplies after the end of the semester.



**Team Contract**

Chris, Earl, Hirat, Yohance
...
Responsible for completing reports, which can be compiled from check-ins and commits
Point of contact for the team and for Prof. Sheese
...
Decisions with disagreement will be made by majority rule.
In the absence of all four when a decision must be made that could result in a tie, ties will be resolved via dice or flipping a coin.

**_Group Member Expectations_**

**Check-Ins**

Each group member is responsible for giving a brief check-in on work progress or any potential issues every Saturday (3pm) and Tuesday (8pm).
